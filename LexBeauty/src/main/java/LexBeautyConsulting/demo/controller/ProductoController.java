...
public class ProductoController {
    ...
    @PostMapping("/guardar")
    public String guardar(@Valid Productos productos, @RequestParam MultipartFile imagenFile, RedirectAttributes redirectAttributes) {

        productoService.save(productos, imagenFile);
